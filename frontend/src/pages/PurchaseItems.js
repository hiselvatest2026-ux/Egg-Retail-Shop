  ...
  return (
    <div className="page">
      <div className="page-header">
        <div>
          <h1 className="page-title">Purchase Items</h1>
          <p className="page-subtitle">Purchase #{id}</p>
        </div>
      </div>
                ...
                <tr key={it.id}>
                  ...
                  <td>
                    <div className="btn-group">
                      ...
                      <button className="btn danger btn-sm" onClick={async()=>{ try{ await deletePurchaseItem(id, it.id); await fetchItems(); }catch(e){ console.error('delete failed', e);} }}>Delete</button>
                    </div>
                  </td>
                </tr>
              ))}
